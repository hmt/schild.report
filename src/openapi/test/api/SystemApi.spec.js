...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SvwsOpenApi.SystemApi();
  });
  ...
  describe('SystemApi', function() {
    describe('systemLogout', function() {
      it('should call systemLogout successfully', function(done) {
        //uncomment below and update the code to test systemLogout
        //instance.systemLogout(function(error) {
